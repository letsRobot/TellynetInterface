...
public class SerialController : MonoBehaviour
{
    ...
    //--------------------------------------------------------------------------\
    // This function was created by Benny and attempts to connect to the existing 
    // serial port. This function should be invoked whenever the bluetooth reciever
    // loses connection as the COM port doesnt actually disappear.
    public void Reconnect()
    {
        serialThread.AttemptConnection();
    }
}
